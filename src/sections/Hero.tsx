      ...
      <div className="container lg:px-0">
        <div className="max-w-3xl">
          ...
          <p className="mt-5 text-white/70 md:text-lg md:leading-8">
            I&apos;m a developer with an affinity for building useful tools and clean interfaces. Working in hospitality taught me that making people happy is easy, give them what they want. Helping them figure out what they actually want, now that&apos;s the hard part.
          </p>
