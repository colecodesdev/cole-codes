        ...
        <div className="">
            <form className='space-y-6' onSubmit={handleSubmit}>
                <div className="flex flex-col gap-4 py-10 px-10">
                    ...
                    <input onChange={(e) => setFormData({...formData, name: e.target.value})} value={formData.name} placeholder='Name' type="text" name='name' id='name' required className="w-full bg-white border-white/10 rounded-3xl px-4 py-3 text-gray-950 hover:outline-none focus:outline-none"/>
                    <input onChange={(e) => setFormData({...formData, email: e.target.value})}  value={formData.email}  placeholder='E-Mail' type="text" name='email' id='email' required className="w-full bg-white border-white/10 rounded-3xl px-4 py-3  text-gray-950 hover:outline-none focus:outline-none"/>
                    </div>
